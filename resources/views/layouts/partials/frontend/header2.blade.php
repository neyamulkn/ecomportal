                                                                ...
                                                                <div class="col-sm-12 hover-menu">
                                                                  <div class="menu">
                                                                    <ul>
                                                                      ...
                                                                      <li>
                                                                        <a href="{{ route('home.category', [$category->slug, $subcategory->slug]) }}"  class="main-menu"><img width="30" src="{{asset('upload/images/category/thumb/'.$subcategory->image)}}" alt=""> {{$subcategory->name}}
                                                                        ...
                                                                        <ul>
                                                                          ...
                                                                          <li><a href="{{ route('home.category',[ $category->slug, $subcategory->slug, $childcategory->slug]) }}" ><img width="30" src="{{asset('upload/images/category/thumb/'.$childcategory->image)}}" alt=""> {{$childcategory->name}}</a></li>
                                                                          @endforeach
                                                                        </ul>
                                                                        @endif
                                                                      </li>
