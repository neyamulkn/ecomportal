            ...
            <div class="card loginArea">
                <div class="card-body">
                    <div id="loginform">
                        ...
                        <form class="form-horizontal" data-parsley-validate  method="get" id="recoverResetform" action="{{ route('seller.password.recoverVerify') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12" style="line-height: 2">
                                    ...
                                    <a href="{{ route('seller.password.recover') }}?emailOrMobile={{Request::get('mobile')}}"> Send code again</a><br/>
                                    
                                </div>
                            </div>
                        </form>
                        @else      
                        <form class="form-horizontal" data-parsley-validate method="post" id="recoverResetform" action="{{ route('seller.password.recover') }}">
                            @csrf 
                            <div class="row">      
                                <div class="col-xs-12">
