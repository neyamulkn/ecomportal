                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required="" data-parsley-required-message = "Category is required" onchange="get_subcategory(this.value)" name="category" id="category" class="select2 form-control custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select onchange="get_subchild_category(this.value)" required name="subcategory" data-parsley-required-message = "Subcategory is required" id="subcategory" class="form-control select2 custom-select">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select onchange="getAttributeByCategory(this.value, 'getAttributesByChildcategory')" name="childcategory"  id="subchildcategory" class="select2 form-control custom-select">
                                                   <option value="">Select first subcategory</option>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function get_subchild_category(id=''){
            ...
            $("#subchildcategory").html('<option value="">Select first category</option>');
        }
        }
