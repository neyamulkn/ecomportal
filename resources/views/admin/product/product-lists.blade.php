                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                ...
                                <a href="{{route('admin.product.list')}}" class="link display-5 ml-auto">{{$all_products}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                ...
                                <a href="{{route('admin.product.list', 'pending')}}" class="link display-5 ml-auto">{{$inactive_products}}</a>
                            </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex no-block align-items-center">
                                ...
                                <a href="{{route('admin.product.list', 'policy')}}" class="link display-5 ml-auto">0</a>
                            </div>
                        </div>
                    </div>
                    </div>
