                                        ...
                                        <tbody id="positionSorting" data-table="homepage_sections">
                                            ...
                                            <tr style="background:{{$data->background_color}};color: {{$data->text_color}}" id="item{{$data->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    @if($data->type == 'categories' && $data->is_default == 1)
                                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.categorySection') }}">Add Section</a>
                                                    <a class="btn btn-primary btn-sm" href="{{ route('admin.categorySection') }}">View Section</a>
                                                    @endif
            ...
            <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form-row">
                        <div class="card-body">
                            <form action="{{route('admin.homepageSection.store')}}" data-parsley-validate  method="POST" >
                                {{csrf_field()}}
                                <div class="form-body">
                                    <!--/row-->
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="3" class="form-control" placeholder="Example: 7" name="item_number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
