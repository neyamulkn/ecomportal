...
$products = App\Models\Product::with('offer_discount.offer:id')->where('status', 'active')->selectRaw('id,title,selling_price,discount,discount_type, slug, feature_image')->orderBy('views', 'desc')->take($section->item_number)->get(); 
?>
@if(count($products)>0)
