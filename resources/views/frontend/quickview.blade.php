				...
				<div class="left-content-product ">
							...
							<div class="content-product-left class-honizol col-sm-5">
								...
								<div class="large-image">
									...
									<img class="product-image-zoom" src="{{asset('frontend')}}/image/catalog/demo/product/travel/2.jpg" data-zoom-image="{{asset('frontend')}}/image/catalog/demo/product/travel/2.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
								</div>
								<div id="thumb-slider" class="full_slider category-slider-inner products-list yt-content-slider" data-rtl="no" data-autoplay="no" data-pagination="no" data-delay="4" data-speed="0.6" data-margin="10" data-items_column0="3" data-items_column1="3" data-items_column2="3" data-items_column3="3" data-items_column4="2" data-arrows="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
										  <div class="image-additional">
											 <a data-index="0" class="img thumbnail" data-image="{{asset('frontend')}}/image/catalog/demo/product/travel/2.jpg" title="Canada Travel One or Two European Facials at  Studio">
											 <img src="{{asset('frontend')}}/image/catalog/demo/product/travel/2.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
											 </a>
										  </div>
										  <div class="image-additional">
											 <a data-index="1" class="img thumbnail " data-image="{{asset('frontend')}}/image/catalog/demo/product/travel/12.jpg" title="Canada Travel One or Two European Facials at  Studio">
											 <img src="{{asset('frontend')}}/image/catalog/demo/product/travel/12.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
											 </a>
										  </div>
										  <div class="image-additional">
											 <a data-index="2" class="img thumbnail " data-image="{{asset('frontend')}}/image/catalog/demo/product/travel/13.jpg" title="Canada Travel One or Two European Facials at  Studio">
											 <img src="{{asset('frontend')}}/image/catalog/demo/product/travel/13.jpg" title="Canada Travel One or Two European Facials at  Studio" alt="Canada Travel One or Two European Facials at  Studio">
											 </a>
										  </div>
								</div>
							</div>
...
<!-- Mirrored from demo.smartaddons.com/templates/html/topdeal/quickview.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 May 2019 08:34:21 GMT -->
</html>